/* 
 * polymap.org
 * Copyright 2012, Falko Bräutigam, and other contributors as indicated
 * by the @authors tag.
 *
...
/**
 * This interface and mixin helps {@link EntityComposite}s to provide
 * the values of their properties as an {@link JSONObject}.
 * <p/>
 * Copied from ANTA2 code base.
 *
...
public interface JsonState
    ...
    /**
     * This might be bad, I'm not quite sure about it yet. Howerver, I just don't
    ...
    */
    ...
    public JSONObject getJsonState( boolean withTweaks );

    public void setJsonState( JSONObject value, QiModule repo, boolean withTweaks );
...
//        public static final FastDateFormat df = FastDateFormat.getInstance( "yyyy-MM-dd' 'HH:mm" );
        ...
        public JSONObject getJsonState( final boolean withTweaks ) {
        ...
        public void setJsonState( final JSONObject json, final QiModule repo, final boolean withTweaks ) {
            stateHolder.visitProperties( new StateVisitor() {
                public void visitProperty( QualifiedName name, Object value ) {
                    Property<Object> prop = stateHolder.getProperty( name );
        ...
        protected void decode( Property prop, JSONObject value, QiModule repo, boolean withTweaks ) {
            try {
                ...
                if (type instanceof ParameterizedType) {
                    ...
                    JSONArray array = value.getJSONArray( name.name() );
                ...
                // ValueComposite
                    ...
                    prop.set( decodeValueComposite( (Class<? extends ValueComposite>)type, 
                            value.getJSONObject( name.name() ), repo, withTweaks ) );
                }
                // property
                else {
                    if (name.name().equals( "identity" )) {
                        ...
                        prop.set( decodeProperty( (Class)type, value.get( name.name() ), withTweaks ) );
//                        log.debug( "   property: " + name.name() + " -> " + prop.get() );
                    }
                }
            }
            catch (JSONException e) {
